...
var Button = function (_React$Component) {
    ...
    Button.prototype.render = function render() {
        ...
        var _a = this.props,
            ...
            ghost = _a.ghost,
            promise = _a.promise,
            others = __rest(_a, ["type", "shape", "size", "className", "htmlType", "children", "icon", "prefixCls", "ghost", "promise"]);var _state = this.state,
...
Button.propTypes = {
    ...
    size: _react2["default"].PropTypes.oneOf(['large', 'default', 'small', 'huge']),
    htmlType: _react2["default"].PropTypes.oneOf(['submit', 'button', 'reset']),
    onClick: _react2["default"].PropTypes.func,
    loading: _react2["default"].PropTypes.bool,
    className: _react2["default"].PropTypes.string,
    icon: _react2["default"].PropTypes.string,
    promise: _react2["default"].PropTypes.bool
};
